...
- **In flight:** Chunk G.4 — LHCI + size-limit + manualChunks tuning. Plán: [G.4.md](./plans/G.4.md), PR TBD.
- **Next up:** Phase H — Feature modules. Phase G ✅ DONE (5/5) po G.4 merge.

Posledná revízia tohto dokumentu: G.4 v review (2026-05-25).
