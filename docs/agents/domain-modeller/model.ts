...
export type Permission =
  | "ADMINISTRATION_VIEW" | "ADMINISTRATION_MODIFY"
  | "CI_VIEW" | "CI_MODIFY"
  | "INCIDENT_VIEW" | "INCIDENT_MODIFY"
  | "PROBLEM_VIEW" | "PROBLEM_MODIFY"
  | "REQUEST_VIEW" | "REQUEST_MODIFY"
  | "CHANGE_VIEW" | "CHANGE_MODIFY" | "CHANGE_APPROVE"
  | "KB_VIEW" | "KB_MODIFY" | "KB_PUBLISH";
...
export type Ci =
  ...
  | (CiBase & {
      class: Exclude<CiClass,
        | "DatabaseInstance" | "Memory" | "Processor" | "OperatingSystem"
        | "Service" | "NetworkServer" | "PortfolioApplication" | "Router"
        | "StorageVolume" | "StoragePool">;
